...
fun Modifier.borderBottom(height: Dp, color: Color, cornerRadius: Dp = 0.dp, cornerRadiusX: Dp = 0.dp, cornerRadiusY: Dp = 0.dp) = composed {
    ...
    this.drawBehind {
        ...
        val strokeHeight = size.height - heightPx / 2

        drawRoundRect(
            color = color,
            size = size.copy(width = width, height = heightPx),
            topLeft = Offset(0f, strokeHeight),
